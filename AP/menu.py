...
class Menu:
    ...
    def face_recognition(self):
        """This function will called with the user chooses to login with facial recognition from Menu 1. I will try to recognise the user from the camera with its dataset.
